...
uses GLOBAL,TIMER,Dos; {Opysannya dostupnoyi informatsiyi dlya yinshykh moduliv}


procedure WORKAR1711(var A: arr; var T:longint);
procedure WORKAR1712(var A: arr);
procedure WORKAR1713(var A: arr);
procedure SortVector(var C: vector; var T:longint);

implementation

{$F+}
procedure WORKAR1711(var a: arr; var T:longint);{Alhorytm "vstavka – obmin" z vykorystannyam dodatkovoho masyvu}
...
with FinishTime do
 GetTime(Hours,Min,Sec,HSec);
T:=ResTime(StartTime,FinishTime);
end;
{$F-}
