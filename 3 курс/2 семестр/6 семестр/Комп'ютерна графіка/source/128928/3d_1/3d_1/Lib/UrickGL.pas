...
Uses Windows, Messages, SysUtils, Classes, OpenGL, U3DPolys;
...
type
  ...
  TsceneGL=class(Tobject)
    ...
    BackR,BackG,BackB:glfloat; {Background color (RGB), between 0.0 and 1.0 }
...
begin
  ...
  SetPosition(0,0,0);  {the camera is in the center of the space}
end;
