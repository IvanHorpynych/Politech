...
namespace Lab6
{
    class CubicSplinesApproximation
    {
        ...
        public CubicSplinesApproximation(double[] x, double[] y, int n)
        {
            BuildSpline(x, y);
        }
        ...
        public void BuildSpline(double[] x, double[] y)
        {
            ...
            BackwardSweepSolver.ForwardSweep(x, y, alpha, beta);

            BackwardSweepSolver.BackwardSweep(alpha, beta, _splines);
