...
double* countDi(double* C, double N){
...
double* countBi(double* C, double* D, double N){
...
void SplineInterpolation(double N)
{
	...
	int k = (b - a) * 100; //кількість точок, які обчислюються на заданому інтервалі
