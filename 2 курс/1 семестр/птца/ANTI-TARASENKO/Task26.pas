...
begin
  ...
  begin
    ...
    begin
      printline(px, '', pz, rightBin(System.Convert.ToString(CTSh, 2), 4), pfi, 'Cдвиг');
      f_printline(px, '', pz, rightBin(System.Convert.ToString(CTSh, 2), 4), pfi, 'Cдвиг');
    end;
    if (pfi = '1') then
    begin
